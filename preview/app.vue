<template>
  <div class="container">
    <bar-top @preview="preview" @genShell="writeShell" @select="handleSelectRoute" :drop-down-routes="dropDownRoutes" :current-route="currentRoute"></bar-top>
    <div class="main">
      <div class="left">
        <preview :url="currentSkeletonScreen.url" type="origin"></preview>
      </div>
      <div class="middle">
        <preview :url="currentSkeletonScreen.skeletonPageUrl" type="skeleton"></preview>
      </div>
      <div class="right">
        <edit v-if="currentSkeletonScreen && currentSkeletonScreen.html" :html="currentSkeletonScreen.html" :current-route="currentRoute"></edit>
      </div>
    </div>
    <el-dialog :visible.sync="dialogVisible" :show-close="false" :modal="true" width="360px">
